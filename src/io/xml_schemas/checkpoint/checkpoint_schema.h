...
class CheckPointFileType: public ::xml_schema::type
{
   ...
   */
  void
  MetaData (::std::unique_ptr< MetaData_type > p);
   ...
   */
  CheckPointFileType (const MetaData_type&,
                      const ParticleData_type&);
   ...
   */
  CheckPointFileType (::std::unique_ptr< MetaData_type >,
...
class MetaDataDataType: public ::xml_schema::type
{
   ...
   */
  void
  input_file (::std::unique_ptr< input_file_type > p);
   ...
   * initializers for required elements and attributes.
   */
  MetaDataDataType (const input_file_type&,
                    const input_file_hash_type&,
                    const end_time_type&,
                    const delta_t_type&);
...
class ParticleType: public ::xml_schema::type
{
   ...
   */
  void
  old_force (::std::unique_ptr< old_force_type > p);
...
CheckPoint (const ::CheckPointFileType& x, 
            const ::xml_schema::namespace_infomap& m = ::xml_schema::namespace_infomap (),
            ::xml_schema::flags f = 0);
...
void
operator<< (::xercesc::DOMElement&, const CheckPointFileType&);

void
operator<< (::xercesc::DOMElement&, const MetaDataDataType&);
