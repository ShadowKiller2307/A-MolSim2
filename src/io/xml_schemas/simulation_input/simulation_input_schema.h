...
class DiffusionInterceptorType;
...
/**
 * @brief Class corresponding to the %DiffusionInterceptorType schema type.
 *
 * @nosubgrouping
 */
class DiffusionInterceptorType: public ::xml_schema::type
{
  public:
  /**
   * @name Constructors
   ...
   * instance.
   */
  DiffusionInterceptorType (const ::xercesc::DOMElement& e,
                            ::xml_schema::flags f = 0,
                            ::xml_schema::container* c = 0);
   ...
   * instance.
   */
  DiffusionInterceptorType (const ::xercesc::DOMAttr& a,
                            ::xml_schema::flags f = 0,
                            ::xml_schema::container* c = 0);
   ...
   * instance.
   */
  DiffusionInterceptorType (const ::std::string& s,
                            const ::xercesc::DOMElement* e,
                            ::xml_schema::flags f = 0,
                            ::xml_schema::container* c = 0);
   ...
   * For polymorphic object models use the @c _clone function instead.
   */
  DiffusionInterceptorType (const DiffusionInterceptorType& x,
                            ::xml_schema::flags f = 0,
                            ::xml_schema::container* c = 0);
   ...
   * models instead of the copy constructor.
   */
  virtual DiffusionInterceptorType*
  _clone (::xml_schema::flags f = 0,
          ::xml_schema::container* c = 0) const;
...
#ifdef XSD_CXX11
  DiffusionInterceptorType&
  operator= (const DiffusionInterceptorType&) = default;
#endif
...
class SimulationInterceptorsType: public ::xml_schema::type
{
   ...
   * @brief Element type.
   */
  typedef ::DiffusionInterceptorType Diffusion_type;
   ...
   */
  void
  Diffusion (::std::unique_ptr< Diffusion_type > p);
...
/**
 * @brief Class corresponding to the %SmoothLJType schema type.
 *
 * @nosubgrouping
 */
class SmoothLJType: public ::xml_schema::type
{
  public:
  /**
   * @name rl
   ...
   * @name cutOffR
   *
   * @brief Accessor and modifier functions for the %cutOffR
   * required attribute.
   */
  //@{
   ...
   * @brief Attribute type.
   */
  typedef ::xml_schema::double_ cutOffR_type;

  /**
   * @brief Attribute traits type.
   */
  typedef ::xsd::cxx::tree::traits< cutOffR_type, char, ::xsd::cxx::tree::schema_type::double_ > cutOffR_traits;
  ...
  ::xsd::cxx::tree::one< cutOffR_type > cutOffR_;
...
class ForcesType: public ::xml_schema::type
{
   ...
   * @name SmoothLJ
   *
   * @brief Accessor and modifier functions for the %SmoothLJ
   * optional element.
   */
  //@{
   ...
   * @brief Element type.
   */
  typedef ::SmoothLJType SmoothLJ_type;

  /**
   * @brief Element optional container type.
   */
  typedef ::xsd::cxx::tree::optional< SmoothLJ_type > SmoothLJ_optional;
   ...
   */
  void
  SmoothLJ (::std::unique_ptr< SmoothLJ_type > p);
...
void
operator<< (::xercesc::DOMElement&, const DiffusionInterceptorType&);

void
operator<< (::xercesc::DOMAttr&, const DiffusionInterceptorType&);

void
operator<< (::xml_schema::list_stream&,
            const DiffusionInterceptorType&);
...
void
operator<< (::xercesc::DOMElement&, const SmoothLJType&);
