...
/**
 * @brief Class corresponding to the %HarmonicType schema type.
 *
 * @nosubgrouping
 */
class HarmonicType: public ::xml_schema::type
{
  public:
  /**
   * @name r0
...
class ForcesType: public ::xml_schema::type
{
   ...
   * @brief Element type.
   */
  typedef ::HarmonicType Harmonic_type;

  /**
   * @brief Element optional container type.
   */
  typedef ::xsd::cxx::tree::optional< Harmonic_type > Harmonic_optional;
   ...
   */
  void
  Harmonic (::std::unique_ptr< Harmonic_type > p);
...
void
operator<< (::xercesc::DOMElement&, const HarmonicType&);
