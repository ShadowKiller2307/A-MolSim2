...
const CuboidSpawnerType::is_membrane_type& CuboidSpawnerType::
is_membrane () const
{
  return this->is_membrane_.get ();
}

CuboidSpawnerType::is_membrane_type& CuboidSpawnerType::
is_membrane ()
{
  return this->is_membrane_.get ();
}
...
const SimulationInterceptorsType::Diffusion_optional& SimulationInterceptorsType::
Diffusion () const
{
  return this->Diffusion_;
}

SimulationInterceptorsType::Diffusion_optional& SimulationInterceptorsType::
Diffusion ()
{
  return this->Diffusion_;
}
...
void SimulationInterceptorsType::
Diffusion (::std::unique_ptr< Diffusion_type > x)
{
  this->Diffusion_.set (std::move (x));
}
...
DiffusionInterceptorType* DiffusionInterceptorType::
_clone (::xml_schema::flags f,
        ::xml_schema::container* c) const
{
  return new class DiffusionInterceptorType (*this, f, c);
}
       ...
       ::xml_schema::flags f)
{
  for (; p.more_content (); p.next_content (false))
  {
    ...
    {
      ::std::unique_ptr< Diffusion_type > r (
...
void
operator<< (::xercesc::DOMElement& e, const DiffusionInterceptorType& i)
{
  e << static_cast< const ::xml_schema::type& > (i);
}
